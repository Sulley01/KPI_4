...
.method constructor <init>(Lmyobfuscated/cci;Z)V
    .locals 3
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;

    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lmyobfuscated/cci;)V
    ...
    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILmyobfuscated/ccw;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;

    invoke-interface {v0}, Lmyobfuscated/cci;->f()B
    ...
    .line 214
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;

    invoke-interface {p1, v2, p4, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILmyobfuscated/cci;I)V
    ...
    invoke-interface {v1, v2, v3}, Lmyobfuscated/cci;->h(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v0}, Lmyobfuscated/cci;->h()I
    ...
    invoke-interface {v0, v4, v5}, Lmyobfuscated/cci;->d(J)Lmyobfuscated/ccj;

    move-result-object v0

    .line 330
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lmyobfuscated/ccj;)V
...
.method static readMedium(Lmyobfuscated/cci;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .prologue
    .line 399
    invoke-interface {p0}, Lmyobfuscated/cci;->f()B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 309
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;

    invoke-interface {v2}, Lmyobfuscated/cci;->h()I
    ...
    invoke-interface {v3}, Lmyobfuscated/cci;->h()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v2}, Lmyobfuscated/cci;->f()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v1}, Lmyobfuscated/cci;->h()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 258
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lmyobfuscated/cci;

    invoke-interface {v4}, Lmyobfuscated/cci;->h()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v2, v4, v5}, Lmyobfuscated/cci;->a(J)V
    :try_end_0
    ...
    invoke-static {v2}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lmyobfuscated/cci;)I
    ...
    invoke-interface {v3}, Lmyobfuscated/cci;->f()B
    ...
    invoke-interface {v1}, Lmyobfuscated/cci;->f()B
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {v0, v2, v3}, Lmyobfuscated/cci;->d(J)Lmyobfuscated/ccj;
    ...
    invoke-virtual {v1, v0}, Lmyobfuscated/ccj;->equals(Ljava/lang/Object;)Z
