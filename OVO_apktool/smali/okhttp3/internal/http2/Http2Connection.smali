...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v1, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lmyobfuscated/cch;

    iget-boolean v2, p0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v0, v1, v2}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lmyobfuscated/cch;Z)V
    ...
    iget-object v2, p1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lmyobfuscated/cci;

    iget-boolean v3, p0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v1, v2, v3}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lmyobfuscated/cci;Z)V
...
.method public final ping()Lokhttp3/internal/http2/Ping;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method final pushDataLater(ILmyobfuscated/cci;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p2, v0, v1}, Lmyobfuscated/cci;->a(J)V

    .line 829
    int-to-long v0, p3

    invoke-interface {p2, v5, v0, v1}, Lmyobfuscated/cci;->read(Lmyobfuscated/ccg;J)J

    .line 1064
    iget-wide v0, v5, Lmyobfuscated/ccg;->b:J
    ...
    .line 2064
    iget-wide v2, v5, Lmyobfuscated/ccg;->b:J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILmyobfuscated/ccg;IZ)V
...
.method final declared-synchronized removePing(I)Lokhttp3/internal/http2/Ping;
    .locals 2
...
.method public final writeData(IZLmyobfuscated/ccg;J)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p2, p1, p3, v1}, Lokhttp3/internal/http2/Http2Writer;->data(ZILmyobfuscated/ccg;I)V
    ...
    :goto_0
    invoke-virtual {v3, v0, p1, p3, v2}, Lokhttp3/internal/http2/Http2Writer;->data(ZILmyobfuscated/ccg;I)V
...
.method final writePing(ZIILokhttp3/internal/http2/Ping;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method final writePingLater(ZIILokhttp3/internal/http2/Ping;)V
    .locals 9
