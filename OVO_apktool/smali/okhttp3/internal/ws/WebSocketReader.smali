...
# direct methods
.method constructor <init>(ZLmyobfuscated/cci;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
    .locals 2
    ...
    .line 82
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lmyobfuscated/cci;
...
.method private readControlFrame()V
    ...
    .line 169
    new-instance v6, Lmyobfuscated/ccg;

    invoke-direct {v6}, Lmyobfuscated/ccg;-><init>()V
    ...
    .line 172
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lmyobfuscated/cci;

    iget-wide v2, p0, Lokhttp3/internal/ws/WebSocketReader;->frameLength:J

    invoke-interface {v0, v6, v2, v3}, Lmyobfuscated/cci;->a(Lmyobfuscated/ccg;J)V
    ...
    invoke-virtual {v6, v0, v8, v7}, Lmyobfuscated/ccg;->b([BII)Lmyobfuscated/ccg;
    ...
    .line 176
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lmyobfuscated/cci;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    invoke-interface {v1, v2, v8, v0}, Lmyobfuscated/cci;->a([BII)I
    ...
    invoke-virtual {v6}, Lmyobfuscated/ccg;->n()Lmyobfuscated/ccj;

    move-result-object v1

    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lmyobfuscated/ccj;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lmyobfuscated/ccj;)V
    ...
    .line 1064
    iget-wide v2, v6, Lmyobfuscated/ccg;->b:J
    ...
    .line 199
    invoke-virtual {v6}, Lmyobfuscated/ccg;->g()S

    move-result v1

    .line 200
    invoke-virtual {v6}, Lmyobfuscated/ccg;->o()Ljava/lang/String;
...
.method private readHeader()V
    ...
    invoke-virtual {v0, v4, v5, v3}, Lmyobfuscated/ccx;->timeout(JLjava/util/concurrent/TimeUnit;)Lmyobfuscated/ccx;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lmyobfuscated/ccx;->timeout(JLjava/util/concurrent/TimeUnit;)Lmyobfuscated/ccx;
    ...
    invoke-interface {v0}, Lmyobfuscated/cci;->i()J
    ...
    invoke-interface {v0, v1}, Lmyobfuscated/cci;->a([B)V
...
.method private readMessage(Lmyobfuscated/ccg;)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 265
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lmyobfuscated/cci;

    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    long-to-int v0, v0

    invoke-interface {v2, v3, v6, v0}, Lmyobfuscated/cci;->a([BII)I
    ...
    invoke-virtual {p1, v0, v6, v3}, Lmyobfuscated/ccg;->b([BII)Lmyobfuscated/ccg;
    ...
    invoke-interface {v2, p1, v0, v1}, Lmyobfuscated/cci;->read(Lmyobfuscated/ccg;J)J
...
.method private readMessageFrame()V
    ...
    .line 219
    invoke-direct {p0, v1}, Lokhttp3/internal/ws/WebSocketReader;->readMessage(Lmyobfuscated/ccg;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadMessage(Lmyobfuscated/ccj;)V
...
.method final readUntilNonControlFrame()V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
