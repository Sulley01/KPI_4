...
# instance fields
.field private final c:Lmyobfuscated/kl;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 123
    new-instance v0, Lmyobfuscated/aa;

    invoke-direct {v0, p1}, Lmyobfuscated/aa;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->c:Lmyobfuscated/kl;
    ...
    .line 134
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->c:Lmyobfuscated/kl;

    iget-object v2, p0, Landroid/support/design/widget/BottomNavigationView;->e:Landroid/support/design/internal/BottomNavigationPresenter;

    invoke-virtual {v1, v2}, Lmyobfuscated/kl;->a(Lmyobfuscated/ks;)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/BottomNavigationView;->c:Lmyobfuscated/kl;

    invoke-virtual {v1, v2, v3}, Landroid/support/design/internal/BottomNavigationPresenter;->a(Landroid/content/Context;Lmyobfuscated/kl;)V

    .line 138
    sget-object v1, Lmyobfuscated/z$k;->BottomNavigationView:[I

    sget v2, Lmyobfuscated/z$j;->Widget_Design_BottomNavigationView:I

    invoke-static {p1, p2, v1, p3, v2}, Lmyobfuscated/mv;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lmyobfuscated/mv;

    move-result-object v1

    .line 142
    sget v2, Lmyobfuscated/z$k;->BottomNavigationView_itemIconTint:I
    ...
    sget v3, Lmyobfuscated/z$k;->BottomNavigationView_itemIconTint:I

    .line 144
    invoke-virtual {v1, v3}, Lmyobfuscated/mv;->e(I)Landroid/content/res/ColorStateList;
    ...
    .line 149
    :goto_0
    sget v2, Lmyobfuscated/z$k;->BottomNavigationView_itemTextColor:I
    ...
    sget v3, Lmyobfuscated/z$k;->BottomNavigationView_itemTextColor:I
    ...
    .line 156
    :goto_1
    sget v2, Lmyobfuscated/z$k;->BottomNavigationView_elevation:I
    ...
    invoke-virtual {v1, v2, v5}, Lmyobfuscated/mv;->e(II)I

    move-result v2

    int-to-float v2, v2

    invoke-static {p0, v2}, Lmyobfuscated/hq;->a(Landroid/view/View;F)V

    .line 161
    :cond_0
    sget v2, Lmyobfuscated/z$k;->BottomNavigationView_itemBackground:I

    invoke-virtual {v1, v2, v5}, Lmyobfuscated/mv;->g(II)I
    ...
    .line 164
    sget v2, Lmyobfuscated/z$k;->BottomNavigationView_menu:I
    ...
    iget-object v4, p0, Landroid/support/design/widget/BottomNavigationView;->c:Lmyobfuscated/kl;
    ...
    .line 3377
    sget v1, Lmyobfuscated/z$c;->design_bottom_navigation_shadow_color:I

    .line 3378
    invoke-static {p1, v1}, Lmyobfuscated/es;->c(Landroid/content/Context;I)I
    ...
    sget v4, Lmyobfuscated/z$d;->design_bottom_navigation_shadow_height:I
    ...
    .line 174
    :cond_2
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->c:Lmyobfuscated/kl;
    ...
    invoke-virtual {v0, v1}, Lmyobfuscated/kl;->a(Lmyobfuscated/kl$a;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1}, Lmyobfuscated/kl;->b(Landroid/os/Bundle;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0, v2}, Lmyobfuscated/kl;->a(Landroid/os/Bundle;)V
...
.method public setSelectedItemId(I)V
    ...
    invoke-virtual {v0, p1}, Lmyobfuscated/kl;->findItem(I)Landroid/view/MenuItem;
