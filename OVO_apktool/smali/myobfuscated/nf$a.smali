.class public abstract Lmyobfuscated/nf$a;
...
# static fields
.field protected static final a:Lmyobfuscated/ng;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 1373
    new-instance v0, Lmyobfuscated/nf$a$1;

    invoke-direct {v0}, Lmyobfuscated/nf$a$1;-><init>()V

    sput-object v0, Lmyobfuscated/nf$a;->b:Landroid/view/animation/Interpolator;

    .line 1380
    new-instance v0, Lmyobfuscated/nf$a$2;

    invoke-direct {v0}, Lmyobfuscated/nf$a$2;-><init>()V

    sput-object v0, Lmyobfuscated/nf$a;->c:Landroid/view/animation/Interpolator;
    ...
    .line 1397
    new-instance v0, Lmyobfuscated/nh$a;

    invoke-direct {v0}, Lmyobfuscated/nh$a;-><init>()V

    sput-object v0, Lmyobfuscated/nf$a;->a:Lmyobfuscated/ng;
    ...
    .line 1399
    :cond_0
    new-instance v0, Lmyobfuscated/nh$b;

    invoke-direct {v0}, Lmyobfuscated/nh$b;-><init>()V
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lmyobfuscated/nf$a;->d:I
...
.method public static a(Landroid/support/v7/widget/RecyclerView$v;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v11, p0, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/view/View;
...
.method public static a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;Landroid/support/v7/widget/RecyclerView$v;I)V
    .locals 4
    ...
    .line 1913
    instance-of v1, v0, Lmyobfuscated/nf$e;

    if-eqz v1, :cond_1

    .line 1914
    check-cast v0, Lmyobfuscated/nf$e;

    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/view/View;

    iget-object v2, p2, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/view/View;

    invoke-interface {v0, v1, v2}, Lmyobfuscated/nf$e;->a(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView$i;->e(Landroid/view/View;)I
    ...
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView$i;->g(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$i;->f(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView$i;->h(Landroid/view/View;)I
...
.method public static b(Landroid/support/v7/widget/RecyclerView$v;)V
    .locals 1
...
.method public final a(Landroid/support/v7/widget/RecyclerView;IIJ)I
    ...
    sget v3, Lmyobfuscated/jt$a;->item_touch_helper_max_drag_scroll_per_frame:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    iput v2, p0, Lmyobfuscated/nf$a;->d:I
    ...
    sget-object v4, Lmyobfuscated/nf$a;->c:Landroid/view/animation/Interpolator;
    ...
    sget-object v3, Lmyobfuscated/nf$a;->b:Landroid/view/animation/Interpolator;
...
.method public a(Landroid/support/v7/widget/RecyclerView;I)J
    ...
    .line 15342
    iget-wide v0, v0, Landroid/support/v7/widget/RecyclerView$f;->k:J

    goto :goto_0

    .line 15378
    :cond_2
    iget-wide v0, v0, Landroid/support/v7/widget/RecyclerView$f;->j:J
...
.method public a(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-interface {v0, v1}, Lmyobfuscated/ng;->a(Landroid/view/View;)V
...
.method final b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;)I
    ...
    .prologue
    .line 1568
    invoke-virtual {p0, p1, p2}, Lmyobfuscated/nf$a;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;)I
...
.method public final c(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;)Z
    .locals 2

    .prologue
    .line 1573
    invoke-virtual {p0, p1, p2}, Lmyobfuscated/nf$a;->b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$v;)I
