...
.method protected final a(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 1000
    iget-object v0, v0, Lmyobfuscated/bkb;->b:Ljava/util/Queue;
...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lmyobfuscated/bjn;->a(Landroid/content/Context;)Lmyobfuscated/bjn;

    move-result-object v1

    .line 5000
    new-instance v2, Lmyobfuscated/bju;

    invoke-virtual {v1}, Lmyobfuscated/bjn;->a()I

    move-result v3

    invoke-direct {v2, v3, v0}, Lmyobfuscated/bju;-><init>(ILandroid/os/Bundle;)V

    invoke-virtual {v1, v2}, Lmyobfuscated/bjn;->a(Lmyobfuscated/bjv;)Lmyobfuscated/bin;
    ...
    new-instance v2, Lmyobfuscated/bki;

    invoke-direct {v2}, Lmyobfuscated/bki;-><init>()V

    invoke-static {p0, v1, v0, v2}, Lmyobfuscated/bkj;->a(Landroid/content/Context;Ljava/lang/String;[BLmyobfuscated/bki;)V

    :cond_b
    const-string v0, "_nr"

    invoke-static {p0, v0, p1}, Lmyobfuscated/bkk;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lmyobfuscated/bkh;->a(Landroid/content/Context;)Lmyobfuscated/bkh;

    move-result-object v1

    invoke-virtual {v1, v0}, Lmyobfuscated/bkh;->c(Landroid/os/Bundle;)Z
    ...
    invoke-static {p0, v1, p1}, Lmyobfuscated/bkk;->a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    :cond_f
    new-instance v0, Lmyobfuscated/bkg;
    ...
    invoke-direct {v0, v1}, Lmyobfuscated/bkg;-><init>(Ljava/lang/String;)V
...
.method public final c(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lmyobfuscated/bkk;->a(Landroid/content/Context;)Lcom/google/android/gms/measurement/AppMeasurement;
