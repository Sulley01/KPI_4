...
.field private static b:Lmyobfuscated/bjm;

.field private static c:Lmyobfuscated/bjm;
...
.method private static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)Lmyobfuscated/bjm;
    .locals 2
    ...
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:Lmyobfuscated/bjm;

    if-nez v0, :cond_0

    new-instance v0, Lmyobfuscated/bjm;

    invoke-direct {v0, p0, p1}, Lmyobfuscated/bjm;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:Lmyobfuscated/bjm;
    ...
    :cond_1
    :try_start_1
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->b:Lmyobfuscated/bjm;
    ...
    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->b:Lmyobfuscated/bjm;
...
.method private final a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-static {p1, v4}, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a(Landroid/content/Context;Ljava/lang/String;)Lmyobfuscated/bjm;
    ...
    invoke-virtual {v1, p2, v2}, Lmyobfuscated/bjm;->a(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    :cond_9
    invoke-static {}, Lmyobfuscated/bkb;->a()Lmyobfuscated/bkb;
    ...
    :pswitch_0
    iget-object v0, v3, Lmyobfuscated/bkb;->a:Ljava/util/Queue;
    ...
    invoke-virtual {v3, p1, v0}, Lmyobfuscated/bkb;->a(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, v3, Lmyobfuscated/bkb;->b:Ljava/util/Queue;
