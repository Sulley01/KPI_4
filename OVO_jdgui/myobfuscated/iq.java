...
public final class iq
{
    ...
    implements iq.b
  {
    ...
    {
      if ((paramImageView instanceof iw)) {
        return ((iw)paramImageView).getSupportImageTintList();
      }
      return null;
    }
    ...
    {
      if ((paramImageView instanceof iw)) {
        ((iw)paramImageView).setSupportImageTintList(paramColorStateList);
      }
    }
    ...
    {
      if ((paramImageView instanceof iw)) {
        ((iw)paramImageView).setSupportImageTintMode(paramMode);
      }
    }
    ...
    {
      if ((paramImageView instanceof iw)) {
        return ((iw)paramImageView).getSupportImageTintMode();
      }
      return null;
    }
  }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\myobfuscated\iq.class
