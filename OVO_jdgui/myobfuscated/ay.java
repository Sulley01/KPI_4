    ...
    throws Resources.NotFoundException
  {
    ...
    catch (XmlPullParserException localXmlPullParserException2)
    {
      ...
      try
      {
        ...
        ((Resources.NotFoundException)localObject4).initCause((Throwable)localObject1);
      ...
      for (;;)
      {
        try
        {
          ...
          else if (j != 1)
          {
            ...
            {
              localObject5 = localObject4;
              localObject3 = new bb(paramContext, (AttributeSet)localObject3, (XmlPullParser)localObject4);
              continue;
            }
            localObject5 = localObject4;
          ...
          return (Interpolator)localObject3;
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\myobfuscated\ay.class
