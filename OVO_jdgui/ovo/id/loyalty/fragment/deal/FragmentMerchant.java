...
import myobfuscated.cgn;
import myobfuscated.cgn.a;
import myobfuscated.chv;
import myobfuscated.cru;
import myobfuscated.cub;
import myobfuscated.cud;
import myobfuscated.cus;
import myobfuscated.cvt;
import myobfuscated.cwc;
import myobfuscated.cws;
import myobfuscated.cxc;
import myobfuscated.lx;
import ovo.id.loyalty.adapters.MerchantAdapter;
import ovo.id.loyalty.fragment.base.BaseFragment;
import ovo.id.loyalty.models.Merchant;
import ovo.id.loyalty.responses.DataListResponse;

public final class FragmentMerchant
  extends BaseFragment
  implements SwipeRefreshLayout.b, cew, cxc<Merchant, DataListResponse<Merchant>>
{
  public static final a d = new a((byte)0);
  public cus b;
  public MerchantAdapter c;
  ...
  {
    cgn.a().a(new cru((cxc)this)).a().a(this);
  }
  
  public final void c(boolean paramBoolean)
  {
    MerchantAdapter localMerchantAdapter = this.c;
    if (localMerchantAdapter == null) {
      bwj.a("adapter");
    }
    localMerchantAdapter.a(paramBoolean);
  }
  ...
  public final void o_()
  {
    ...
    if (localObject != null)
    {
      ...
      ((RecyclerView)localObject).a((RecyclerView.m)new cwc(localLinearLayoutManager, (cud)localcus));
    }
  }
  ...
  public final void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.c = new MerchantAdapter((cxc)this);
    paramView = this.m;
    ...
    if (paramView != null)
    {
      ...
      paramView.a((RecyclerView.m)new cwc(paramBundle, (cud)localcus));
      paramBundle = this.c;
      if (paramBundle == null) {
        bwj.a("adapter");
      }
  ...
  {
    b(FragmentMerchant paramFragmentMerchant)
    {
      super();
    }
  }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\ovo\id\loyalty\fragment\deal\FragmentMerchant.class
