...
public final class TypeAdapters
{
  ...
  static
  {
    ...
    {
      public final AtomicInteger read(JsonReader paramAnonymousJsonReader)
        throws IOException
      {
        try
        {
      ...
      public final void write(JsonWriter paramAnonymousJsonWriter, AtomicInteger paramAnonymousAtomicInteger)
        throws IOException
      {
    ...
    {
      public final AtomicBoolean read(JsonReader paramAnonymousJsonReader)
        throws IOException
      {
        return new AtomicBoolean(paramAnonymousJsonReader.nextBoolean());
      }
      
      public final void write(JsonWriter paramAnonymousJsonWriter, AtomicBoolean paramAnonymousAtomicBoolean)
        throws IOException
      {
    ...
    {
      public final AtomicIntegerArray read(JsonReader paramAnonymousJsonReader)
        throws IOException
      {
      ...
      public final void write(JsonWriter paramAnonymousJsonWriter, AtomicIntegerArray paramAnonymousAtomicIntegerArray)
        throws IOException
      {
        paramAnonymousJsonWriter.beginArray();
        int i = 0;
    ...
    {
      public final Currency read(JsonReader paramAnonymousJsonReader)
        throws IOException
      {
        return Currency.getInstance(paramAnonymousJsonReader.nextString());
      }
      
      public final void write(JsonWriter paramAnonymousJsonWriter, Currency paramAnonymousCurrency)
        throws IOException
      {
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(Class<T1> paramClass, final TypeAdapter<T1> paramTypeAdapter)
  {
    new TypeAdapterFactory()
    {
      public final <T2> TypeAdapter<T2> create(final Gson paramAnonymousGson, TypeToken<T2> paramAnonymousTypeToken)
      {
        paramAnonymousGson = paramAnonymousTypeToken.getRawType();
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\google\gson\internal\bind\TypeAdapters.class
