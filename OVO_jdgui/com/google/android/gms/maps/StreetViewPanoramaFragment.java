  ...
  extends Fragment
{
  ...
  static final class b
    extends amb<StreetViewPanoramaFragment.a>
  {
    private final Fragment d;
    private amm<StreetViewPanoramaFragment.a> e;
    private Activity f;
    ...
    private final void h()
    {
      ...
      try
      {
        ...
        this.e.a(new StreetViewPanoramaFragment.a(this.d, (bda)localObject));
        ...
        for (;;)
        {
          if (((Iterator)localObject).hasNext())
          {
            ...
            StreetViewPanoramaFragment.a locala = (StreetViewPanoramaFragment.a)this.a;
            try
            {
              locala.a.a(new bfl(localbcs));
            }
    ...
    protected final void a(amm<StreetViewPanoramaFragment.a> paramamm)
    {
      this.e = paramamm;
      h();
    }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\maps\StreetViewPanoramaFragment.class
