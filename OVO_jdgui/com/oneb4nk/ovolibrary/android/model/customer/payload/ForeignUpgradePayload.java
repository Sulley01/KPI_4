...
public class ForeignUpgradePayload
  extends BankUpgradePayload
{
  ...
  public static ForeignUpgradePayload create(Context paramContext, Customer paramCustomer)
  {
    ForeignUpgradePayload localForeignUpgradePayload = new ForeignUpgradePayload();
    localForeignUpgradePayload.updateData(paramCustomer);
    localForeignUpgradePayload.setDeviceId(DeviceIdHelper.getDeviceSerialNumber(paramContext));
    return localForeignUpgradePayload;
  }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\oneb4nk\ovolibrary\android\model\customer\payload\ForeignUpgradePayload.class
