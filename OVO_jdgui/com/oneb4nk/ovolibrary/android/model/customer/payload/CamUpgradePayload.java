...
public class CamUpgradePayload
  extends BankUpgradePayload
{
  ...
  public static CamUpgradePayload create(Context paramContext, Customer paramCustomer)
  {
    CamUpgradePayload localCamUpgradePayload = new CamUpgradePayload();
    localCamUpgradePayload.updateData(paramCustomer);
    localCamUpgradePayload.setDeviceId(DeviceIdHelper.getDeviceSerialNumber(paramContext));
    return localCamUpgradePayload;
  }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\oneb4nk\ovolibrary\android\model\customer\payload\CamUpgradePayload.class
