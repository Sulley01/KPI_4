    ...
    throws IOException
  {
    ...
    if ((HttpMethod.permitsRequestBody(localRequest.method())) && (localRequest.body() != null))
    {
      ...
      if (paramChain == null)
      {
        ...
        cch localcch = ccp.a((ccv)localObject);
        localRequest.body().writeTo(localcch);
        localcch.close();
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\okhttp3\internal\http\CallServerInterceptor.class
