  ...
  implements Interceptor
{
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = new ccn(paramChain.body().source());
        ...
        ((Response.Builder)localObject1).body(new RealResponseBody(paramChain.header("Content-Type"), -1L, ccp.a((ccw)localObject2)));
      }
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\okhttp3\internal\http\BridgeInterceptor.class
