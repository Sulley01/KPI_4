...
class Huffman
{
  ...
  void encode(ccj paramccj, cch paramcch)
    throws IOException
  {
    int j = 0;
    long l = 0L;
    ...
    if (i > 0) {
      paramcch.h((int)(255 >>> i | l << 8 - i));
    }
  }
  
  int encodedLength(ccj paramccj)
  {
    long l = 0L;
    int i = 0;
    while (i < paramccj.h())
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\okhttp3\internal\http2\Huffman.class
