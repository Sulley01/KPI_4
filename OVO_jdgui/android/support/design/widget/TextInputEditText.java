  ...
  extends AppCompatEditText
{
  ...
  public InputConnection onCreateInputConnection(EditorInfo paramEditorInfo)
  {
    ...
    for (ViewParent localViewParent = getParent();; localViewParent = localViewParent.getParent()) {
      ...
      {
        if ((localViewParent instanceof ne)) {
          paramEditorInfo.hintText = ((ne)localViewParent).getHint();
        }
      }
      else {
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\TextInputEditText.class
