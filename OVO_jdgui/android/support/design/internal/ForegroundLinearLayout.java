  ...
  extends LinearLayoutCompat
{
  ...
  public ForegroundLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, z.k.ForegroundLinearLayout, paramInt, 0);
    this.f = paramContext.getInt(z.k.ForegroundLinearLayout_android_foregroundGravity, this.f);
    paramAttributeSet = paramContext.getDrawable(z.k.ForegroundLinearLayout_android_foreground);
    if (paramAttributeSet != null) {
      setForeground(paramAttributeSet);
    }
    this.a = paramContext.getBoolean(z.k.ForegroundLinearLayout_foregroundInsidePadding, true);
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\internal\ForegroundLinearLayout.class
