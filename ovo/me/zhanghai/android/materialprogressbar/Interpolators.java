...
class Interpolators
{
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
    private static final Path PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X;
    
    static
    {
      Path localPath = new Path();
      PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X = localPath;
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
    private static final Path PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X;
    
    static
    {
      Path localPath = new Path();
      PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X = localPath;
      localPath.moveTo(0.0F, 0.0F);
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
    private static final Path PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X;
    
    static
    {
      Path localPath = new Path();
      PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X = localPath;
      localPath.moveTo(0.0F, 0.0F);
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
    private static final Path PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X;
    
    static
    {
      Path localPath = new Path();
      PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X = localPath;
      localPath.moveTo(0.0F, 0.0F);
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_TRIM_PATH_END);
    private static final Path PATH_TRIM_PATH_END;
    
    static
    {
      Path localPath = new Path();
      PATH_TRIM_PATH_END = localPath;
  ...
  {
    public static final Interpolator INSTANCE = ig.a(PATH_TRIM_PATH_START);
    private static final Path PATH_TRIM_PATH_START;
    
    static
    {
      Path localPath = new Path();
      PATH_TRIM_PATH_START = localPath;
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\me\zhanghai\android\materialprogressbar\Interpolators.class
