  ...
  static
  {
    JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess()
    {
        ...
        throws IOException
      {
        ...
        throw new IllegalStateException("Expected a name but was " + paramAnonymousJsonReader.peek() + paramAnonymousJsonReader.locationString());
      }
    };
  }
            ...
            else
            {
              ...
              else
              {
                ...
                else if ((k == 5) || (k == 6))
                {
                  ...
                  continue;
                  label460:
                  if ((k == 2) && (j != 0) && ((l1 != Long.MIN_VALUE) || (i != 0)) && ((l1 != 0L) || (i == 0)))
                  {
                    if (i != 0) {}
                    for (;;)
                    {
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\google\gson\stream\JsonReader.class
