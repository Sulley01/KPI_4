  ...
  extends BankChallengeCode
{
  ...
  public static CamChallengeCode create(Context paramContext, Customer paramCustomer, String paramString)
  {
    CamChallengeCode localCamChallengeCode = new CamChallengeCode();
    localCamChallengeCode.updateData(paramCustomer);
    localCamChallengeCode.setDeviceId(DeviceIdHelper.getDeviceSerialNumber(paramContext));
    localCamChallengeCode.setChallengeCode(paramString);
    return localCamChallengeCode;
  }
  
  public static CamChallengeCode create(Context paramContext, Customer paramCustomer, String paramString, Boolean paramBoolean)
  {
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\com\oneb4nk\ovolibrary\android\model\customer\payload\CamChallengeCode.class
