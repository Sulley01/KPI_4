...
public final class ckt
  extends cjv
{
  public ckt(cxi paramcxi, cmm paramcmm, Double paramDouble1, Double paramDouble2)
  {
    ...
    implements bvv<Integer, Integer, Double, Double, EndlessNetworkRequestListener<? super DataListResponse<Deal>>, btt>
  {
    ...
    {
      return "getNearPromo(IIDDLovo/id/loyalty/network/request/EndlessNetworkRequestListener;)V";
    }
  }
}


/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\myobfuscated\ckt.class
