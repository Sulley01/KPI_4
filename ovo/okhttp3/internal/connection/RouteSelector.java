...
public final class RouteSelector
{
    ...
    throws IOException
  {
    ...
    for (int i = this.address.url().port(); (i <= 0) || (i > 65535); i = localInetSocketAddress.getPort())
    {
  ...
  {
    if (paramProxy != null) {
      paramHttpUrl = Collections.singletonList(paramProxy);
    }
    for (;;)
    {
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\okhttp3\internal\connection\RouteSelector.class
