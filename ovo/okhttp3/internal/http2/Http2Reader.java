  ...
  implements Closeable
{
  ...
  Http2Reader(cci paramcci, boolean paramBoolean)
  {
    ...
    throws IOException
  {
    ...
    ccj localccj = ccj.b;
    if (paramInt1 > 0) {
      localccj = this.source.d(paramInt1);
    }
    paramHandler.goAway(paramByte, localErrorCode, localccj);
  }
  ...
  static int readMedium(cci paramcci)
    throws IOException
  {
    return (paramcci.f() & 0xFF) << 16 | (paramcci.f() & 0xFF) << 8 | paramcci.f() & 0xFF;
  }
    ...
    throws IOException
  {
    ...
    paramHandler.pushPromise(paramInt2, this.source.h() & 0x7FFFFFFF, readHeaderBlock(lengthWithoutPadding(paramInt1 - 4, paramByte, s), s, paramByte, paramInt2));
  }
    ...
    implements ccw
  {
    ...
    ContinuationSource(cci paramcci)
    {
      this.source = paramcci;
    }
      ...
      throws IOException
    {
      ...
      do
      {
        ...
        break;
        paramLong = this.source.read(paramccg, Math.min(paramLong, this.left));
      } while (paramLong == -1L);
  ...
  static abstract interface Handler
  {
    ...
    public abstract void alternateService(int paramInt1, String paramString1, ccj paramccj, String paramString2, int paramInt2, long paramLong);
    
    public abstract void data(boolean paramBoolean, int paramInt1, cci paramcci, int paramInt2)
      throws IOException;
    
    public abstract void goAway(int paramInt, ErrorCode paramErrorCode, ccj paramccj);
...
/* Location:              C:\dex2jar-2.0\classes-dex2jar.jar!\okhttp3\internal\http2\Http2Reader.class
